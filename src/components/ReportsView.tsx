  ...
  return (
    <div className="w-full h-full flex flex-col bg-[#020617] overflow-hidden">
        ...
        {selectedFlight ? (
            ...
            <>
                <div className="min-h-[160px] py-6 bg-[#0a0f1d] border-b border-slate-800 flex flex-col justify-center px-8 shrink-0 gap-6">
                                    ...
                                    sortedData.map(flight => {
                                        ...
                                        >
                                            <td className="px-2 border-r border-slate-800/50 text-center pl-4">
                                                <span className={`bg-slate-800 ${statusColorClass} border border-slate-700 px-1.5 py-0.5 rounded text-[10px] font-black`}>{flight.airlineCode}</span>
                                            </td>
